...
export default function Navbar() {
  ...
  const navigation = [
    { title: "Home", path: "/", isActive: path === "/" ? true : false },
    {
      title: "About Us",
      path: "/about_us",
      isActive: path === "/about_us" ? true : false,
    },
    {
      title: "Webinar",
      path: "/webinar",
      isActive: path === "/webinar" ? true : false,
    },
    {
      title: "Blog",
      path: "/blog",
      isActive: path.includes("blog") ? true : false,
    },
    {
      title: "Contact Us",
      path: "/contact_us",
      isActive: path === "/contact_us" ? true : false,
    },
  ];
  return (
    <>
      ...
      <nav className="sticky top-0 z-50">
        <div
          ...
          className="bg-white border-b w-full  md:text-sm "
        >
