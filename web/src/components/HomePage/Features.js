  ...
  return (
    ...
    <div className=' p-4 md:p-12 grid  md:grid-cols-2 lg:grid-cols-4 gap-4 w-full'>
      {featuresData.map((el, index) => (
        <div key={index} className='border-b-[0.3rem] rounded-t-xl rounded-b-2xl hover:border-red-500 border-blue-700 p-12 bg-[#F2F1FE]'>
    ...
    <div className='grid md:grid-cols-[auto_auto] gap-5  p-2 md:p-10'>
        <div>
          ...
          <div className='p-4 md:p-10  flex flex-col gap-4'>
            ...
            <div className='flex flex-col gap-4'>
                <p className='md:text-4xl font-bold'>Want to stay informed about us?</p>
                <p className='text-sm'>Don't hesitate to contact us via email or WhatsApp. We're here to assist you and address any questions you may have with pleasure.</p>
       ...
       <div  className='px-2'>
          <div className=' rounded-lg px-4  md:px-6 space-y-6 justify-center py-6' style={{boxShadow: 'rgba(0, 0, 0, 0.16) 0px 10px 36px 0px, rgba(0, 0, 0, 0.06) 0px 0px 0px 1px'}}>
            ...
            <div className=" mx-auto  text-gray-600">
                ...
                <div className="  mx-auto">
                    ...
                    >
                        ...
                        <button
                            className=" px-6 py-2 text-white font-medium bg-indigo-600 hover:bg-indigo-500 active:bg-indigo-600 rounded-lg duration-150"
                        >
                            Submit
                        </button>
                    </form>
